...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalseven/ \
                                     --checkfiles YearChecker.java --fragments "println(" --fragmentcounts 9
  determine_exit_code $?
  # --> GatorGrader CHECK: the "if" fragment exists in the code at least set number of times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalseven/ \
                                     --checkfiles YearChecker.java --fragments "if" --fragmentcounts 4
  determine_exit_code $?
  # --> GatorGrader CHECK: the "else" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalseven/ \
                                     --checkfiles YearChecker.java --fragments "else" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the "==" fragment exists in the code at least three times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalseven/ \
                                     --checkfiles YearChecker.java --fragments "==" --fragmentcounts 3
  determine_exit_code $?
  # --> GatorGrader CHECK: the "REFERENCE_YEAR" fragment exists in the code at least set number of times
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalseven/ \
